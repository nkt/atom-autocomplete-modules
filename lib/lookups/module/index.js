...
const localLookup = new (require('./local'))(Readdir, PH.getModuleDir, PH.removeExtension)
...
const babelLookup = new (require('./babel'))(PH.getProjectPath, Path, findBabelConfig, localLookup, LookupAlias);
// END
