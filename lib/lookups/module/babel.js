  ...
  _generateSuggestion(currentPath, prefix, projectPath) {
    ...
    .then(({config}) => {
      ...
      if (v2Aliases !== undefined) {
        ...
        if (!v1AliasesConfig) {
          atom.notifications.addWarning('Unable to locate any alias configuration for babel-plugin-module-alias', {
            detail: 'Please ensure that you have configured the package-supported alias configuration correctly',
            dismissable: true
          });
